...
class RoboFile extends \Robo\Tasks {
    ...
    public function wordpressSetup(
        $opts = [
            ...
            'wp-theme-dir' => 'headless-wp',
            'wp-theme-name' => 'Scope Web Headless WP Starter',
            'wp-email' => 'admin@headless-wp.com',
        ...
        $this->wp(
            'post update 1 wp-content/themes/headless-wp/post-content/sample-post.txt '.
            '--post_title="Sample Post" --post_name=sample-post'
        );

        // Create homepage content
        $this->wp(
            'post create wp-content/themes/headless-wp/post-content/welcome.txt '.
        ...
        $this->wp(
            ...
            .'"Read the Scope Web blog on Medium" https://medium.com/scopeweb/'
        );
